 ...
 */
export const formatLargeNumber = (num, decimals = 1, currency = '$') => {
 ...
 */
export const formatBalance = (balance, currency = '$', decimals = 2) => {
 ...
 */
export const formatWithWarning = (num, currency = '$', decimals = 1) => {
