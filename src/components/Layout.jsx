...
const Layout = ({ children, showNavigation = true }) => {
  ...
  const navigationItems = [
    { 
      ...
      roles: ['admin', 'seller'] // Both roles can access dashboard
    },
    { 
      path: '/clients', 
      label: 'Clients', 
      ...
      roles: ['admin', 'seller'] // Both roles can access clients
    },
    { 
      path: '/providers', 
      label: 'Providers', 
      ...
      roles: ['admin', 'seller'] // Both roles can access providers
    },
    { 
      path: '/services', 
      label: 'Services', 
      ...
      roles: ['admin', 'seller'] // Both roles can access services
    },
    { 
      path: '/sales', 
      label: 'Sales', 
      ...
      roles: ['admin', 'seller'] // Both roles can access sales
    },
    { 
      path: '/sales/clients', 
      label: 'Client Sales', 
      ...
      roles: ['admin', 'seller'] // Both roles can access client sales
    },
    { 
      path: '/inventory', 
      label: 'Inventory', 
      ...
      roles: ['admin', 'seller'] // Both roles can access inventory
    },
    { 
      path: '/reports', 
      label: 'Reports', 
      ...
      roles: ['admin', 'seller'] // Both roles can access reports
    },
    ...
    { 
      ...
      roles: ['admin', 'seller'] // Both roles can access settings (but content will be filtered)
    },
  ];
